...
for i in range(0,L):
    print('\nslice', i, '/', L)
    N=pd.read_hdf('data/2018-10-15/ne213/oct15_10min_ch0_Slice%d.h5'%i)
    Y=pd.read_hdf('data/2018-10-15/yapfront/oct15_10min_ch1_Slice%d.h5'%i)
    tof.get_gates(N, lg=500, sg=60, offset=10)
    H[i]=tof.tof_spectrum(N.query('species!=-1'),Y,tol_right=tol_right)[0]
