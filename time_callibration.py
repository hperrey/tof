...
g0simple=rdr.load_events('tcdata/wave1_1min3s.txt')
g0=adv.processframe(g0simple)
g1simple=rdr.load_events('tcdata/wave1_2min30s.txt')
g1=adv.processframe(g1simple)
g2simple=rdr.load_events('tcdata/wave1_3min0s.txt')
g2=adv.processframe(g2simple)
g3simple=rdr.load_events('tcdata/wave1_4min0s.txt')
g3=adv.processframe(g3simple)
g4simple=rdr.load_events('tcdata/wave1_6min25s.txt')
g4=adv.processframe(g4simple)
g5simple=rdr.load_events('tcdata/wave1_10min0s.txt')
