...
def tof_hist(df, outpath, tNmax, qdc_min, mode, window, bins, fontsize):
...
fontsize = 10
# tof_hist(D, '/home/rasmus/Documents/ThesisWork/Thesistex/DigitalResults/', window=(-20,130), bins=150, qdc_min=0, tNmax=65, fontsize=fontsize, mode="Time of flight spectrum\nDigital setup")
...
psd(D, '/home/rasmus/Documents/ThesisWork/Thesistex/DigitalResults/', CNN=False, cut=0.141, down=0, up=0.4, qdc_min=0, fontsize=fontsize, title="--- Discrimination cut: Digital setup", arrow1=[2, 0.08, 2.5, 0.01], arrow2=[4.2, 0.09, 4.7, 0.01], box=[2, 0.38])
...
# tof_psd(D, '/home/rasmus/Documents/ThesisWork/Thesistex/DigitalResults/', psdown=-0.1, psup=0.5, tofdown=0, tofup=100, qdc_min=0, cut=0.141, fontsize=fontsize, title="--- Discrimination cut: Digital setup", txt_xy_gamma=[10, 0.3], txt_xy_neutron=[70, 0.3], arrow_xy_gamma=[5, 0.17], arrow_xy_neutron=[50, 0.2], CNN=False)
...
#tof_hist_filt(D, '/home/rasmus/Documents/ThesisWork/Thesistex/DigitalResults/', cut=0.141, window=(-20,130), bins=150, qdc_min=0, fontsize=fontsize, mode="Filtered time of flight spectrum\nCharge comparisson method\nDigital setup", CNN=False)
